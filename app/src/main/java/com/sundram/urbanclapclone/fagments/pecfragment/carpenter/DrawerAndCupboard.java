 ...
 */
public class DrawerAndCupboard extends Fragment implements PECAdapter.OnServiceItemClick{
    ...
    public void implementRecyclerview() {
        ...
        view_section_heading.setText("Drawer And Cupboard");
