 ...
 */
public class InverterAndStabilizer extends Fragment implements PECAdapter.OnServiceItemClick {
    ...
    public void implementRecyclerview() {
        ...
        view_section_heading.setText("Inverter And Stabilizer");
