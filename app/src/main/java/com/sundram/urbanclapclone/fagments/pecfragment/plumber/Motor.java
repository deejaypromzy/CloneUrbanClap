 ...
 */
public class Motor extends Fragment implements PECAdapter.OnServiceItemClick {
    ...
    public void implementRecyclerview() {
        ...
        view_section_heading.setText("Motor");
    ...
    public void setDataToRecycler() {
        mList.add(new CarpenterDataModel("Motor Installation","", "1254", "20",0));
        mList.add(new CarpenterDataModel("Motor Air Cavity Repair","", "1254", "20",0));
