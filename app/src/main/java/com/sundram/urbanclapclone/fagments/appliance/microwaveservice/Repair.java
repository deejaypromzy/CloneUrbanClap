...
public class Repair extends Fragment implements PECAdapter.OnServiceItemClick {
    ...
    public void setDataToRecycler() {
        mList.add(new CarpenterDataModel("Microwave Repair(Not Heating)","", "1254", "200",0));
        mList.add(new CarpenterDataModel("Microwave Repair(Button Not Working)","", "1254", "300",0));
        mList.add(new CarpenterDataModel("Microwave Repair(Noise)","", "1254", "100",0));
