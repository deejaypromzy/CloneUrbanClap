 ...
 */
public class DoorBell extends Fragment implements PECAdapter.OnServiceItemClick {
    ...
    public void implementRecyclerview() {
        ...
        view_section_heading.setText("Door Bell");
    ...
    public void setDataToRecycler() {
        mList.add(new CarpenterDataModel("Door bell Installation","", "1254", "20",0));
        mList.add(new CarpenterDataModel("Door Bell Uninstallation)","", "1254", "20",0));
