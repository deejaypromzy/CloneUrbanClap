...
public class ViewAllCarpetCleaningService extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Carpet Cleaning Service");
    ...
    private void getint() {
        ...
        section_heading.setText("Carpet Cleaning Service");
    ...
    public void settingupTheRecyclerView() {
        ...
        data.add(new SectionViewAllServiceListModel("25-50sq. ft.","899","300","Carpet Cleaning","60 min",0,0,R.drawable.carpet_cleaning));
        data.add(new SectionViewAllServiceListModel("50-100sq. ft.","1299","200","Carpet Cleaning","60 min",0,0,R.drawable.carpet_cleaning));
        data.add(new SectionViewAllServiceListModel("100-150sq. ft.","1499","300","Carpet Cleaning","60 min",0,0,R.drawable.carpet_cleaning));
        data.add(new SectionViewAllServiceListModel("150-200 sq. ft.","1699","200","Carpet Cleaning","60 min",0,0,R.drawable.carpet_cleaning));
        adapter = new SectionViewAllServiceListAdapter(this, data, new SectionViewAllServiceListAdapter.OnServiceItemClick() {
            ...
            public void onClick(String position, int pos, View view) {
                if (!position.equals("0")) {// !position.equals("0") is use to show or hide the visibility of bottom button
                    ...
                    Toast.makeText(ViewAllCarpetCleaningService.this, "" + pos, Toast.LENGTH_SHORT).show();
                } else {
    ...
    public void onBackPressed() {
        startActivity(new Intent(ViewAllCarpetCleaningService.this, CarpetCleanigActivity.class));
        finish();
    }
}
