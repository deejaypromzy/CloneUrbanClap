...
import com.sundram.urbanclapclone.viewallserviceactivity.appliance.ViewAllAcServices;

public class AcServiceAndRepair extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbarLayout.setTitle("Ac Service and Repair");
    }
    ...
    public void settingUpVideoView() {
        ...
        mVideoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                Toast.makeText(AcServiceAndRepair.this, "Thank you for watching..",
    ...
    public void onBackPressed() {
        Intent back = new Intent(AcServiceAndRepair.this, ApplianceAndEcRepair.class);
        startActivity(back);
        finish();
    }
