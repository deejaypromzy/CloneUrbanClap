...
public class ViewAllKitchenDeepCleaning extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Kitchen Cleaning Service");
    }
    private void getint() {
        toolbarViewAll = findViewById(R.id.toolbarViewAll);
        ...
        section_heading.setText("Kitchen Cleaning Service");
    ...
    public void settingupTheRecyclerView() {
        ...
        data.add(new SectionViewAllServiceListModel("Chimney Deep Cleaning","120","40","Kitchen Cleaning","60 min",0,0,R.drawable.kitchen_cleaning));
        data.add(new SectionViewAllServiceListModel("Kitchen Cleaning(Without Chimney)","180","40","Kitchen Cleaning","60 min",0,0,R.drawable.kitchen_cleaning));
        data.add(new SectionViewAllServiceListModel("Kitchen Cleaning(With Chimney)","190","40","Kitchen Cleaning","60 min",0,0,R.drawable.kitchen_cleaning));
        data.add(new SectionViewAllServiceListModel("Trolley and Shelf Cleaning","200","40","Kitchen Cleaning","60 min",0,0,R.drawable.kitchen_cleaning));
        adapter = new SectionViewAllServiceListAdapter(this, data, new SectionViewAllServiceListAdapter.OnServiceItemClick() {
            ...
            public void onClick(String position, int pos, View view) {
                if (!position.equals("0")) {// !position.equals("0") is use to show or hide the visibility of bottom button
                    ...
                    Toast.makeText(ViewAllKitchenDeepCleaning.this, "" + pos, Toast.LENGTH_SHORT).show();
                } else {
    ...
    public void onBackPressed() {
        startActivity(new Intent(ViewAllKitchenDeepCleaning.this, KitchenCleaningActivity.class));
        finish();
    }
}
