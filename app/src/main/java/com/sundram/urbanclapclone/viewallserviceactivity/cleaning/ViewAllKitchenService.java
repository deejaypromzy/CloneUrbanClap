...
import com.sundram.urbanclapclone.fagments.cleaningservice.KitchenDeepCleaning;
import com.sundram.urbanclapclone.fagments.salonathomeservice.FragmentViewAllTab2;

public class ViewAllKitchenService extends AppCompatActivity {
    ...
    //Fragments
    KitchenDeepCleaning kitchenDeepCleaning;

    String[] tabTitle = {"Kitchen Cleaning"};
    int[] unreadCount = {0};
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                startActivity(new Intent(ViewAllKitchenService.this, KitchenCleaningActivity.class));
                finish();
                return true;
        }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        kitchenDeepCleaning = new KitchenDeepCleaning();

        adapter.addFragment(kitchenDeepCleaning, "Kitchen Cleaning");
