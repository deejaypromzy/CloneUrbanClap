...
import com.sundram.urbanclapclone.fagments.appliance.refrigeratorService.Repair;
import com.sundram.urbanclapclone.fagments.appliance.refrigeratorService.Service;
import com.sundram.urbanclapclone.fagments.appliance.washingService.InstallAndUninstall;

public class ViewAllRefrigetorService extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Refrigerator Services");
        setUpTabLayout();
    }
    ...
    public void onBackPressed() {
        startActivity(new Intent(ViewAllRefrigetorService.this, RefrigeratorRepair.class));
        finish();
    }
}
