...
import com.sundram.urbanclapclone.fagments.appliance.rowaterservice.InstallAndUninstall;
import com.sundram.urbanclapclone.fagments.appliance.rowaterservice.Repair;
import com.sundram.urbanclapclone.fagments.appliance.rowaterservice.Service;

public class ViewAllRoAndWaterService extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("RO and Water Services");
        setUpTabLayout();
    }
    ...
    public void setUpViewPager(ViewPager viewPager) {
        ...
        viewPagerAdapter.addFragment(service, "Refrigerator Service");
        viewPagerAdapter.addFragment(repair, "Refrigerator Service");
        viewPagerAdapter.addFragment(installAndUninstall, "Refrigerator Service");
    ...
    public void onBackPressed() {
        startActivity(new Intent(ViewAllRoAndWaterService.this, RoandWaterActivity.class));
        finish();
    }
}
