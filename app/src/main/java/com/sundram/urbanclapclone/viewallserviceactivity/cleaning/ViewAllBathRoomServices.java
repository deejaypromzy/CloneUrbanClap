...
import com.sundram.urbanclapclone.fagments.cleaningservice.BathRoomCleaning;
...
public class ViewAllBathRoomServices extends AppCompatActivity {
    ...
    String[] tabTitle = {"Bathroom Deep Cleaning"};
    int[] unreadCount = {0};
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                startActivity(new Intent(ViewAllBathRoomServices.this, BathroomCleaning.class));
                finish();
                return true;
        }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        bathRoomCleaning = new BathRoomCleaning();

        adapter.addFragment(bathRoomCleaning, "Bathroom Cleaning");
