...
public class ViewAllSofaCleaningServices extends AppCompatActivity {
    ...
    //Fragments
    com.sundram.urbanclapclone.fagments.cleaningservice.SofaCleaning sofaCleaning;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        sofaCleaning = new com.sundram.urbanclapclone.fagments.cleaningservice.SofaCleaning();

        adapter.addFragment(sofaCleaning, "Sofa Cleaning");
