...
public class ViewAllAcServices extends AppCompatActivity {
    ...
    AcService acService;
    AcRepair acRepair;
    AcInstallAndUnInstall acInstallAndUnInstall;
    ...
    public void setUpViewPager(ViewPager viewPager){
        ...
        acRepair = new AcRepair();
        acInstallAndUnInstall = new AcInstallAndUnInstall();

       viewPagerAdapter.addFragment(acService,"AC Service");
       viewPagerAdapter.addFragment(acRepair,"AC Repair");
       viewPagerAdapter.addFragment(acInstallAndUnInstall,"AC Install and UnInstall");
    ...
    public void onBackPressed() {
        startActivity(new Intent(ViewAllAcServices.this, AcServiceAndRepair.class));
        finish();
    }
}
