...
public class ViewAllBathroomCleaningService extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Bathroom Cleaning Service");
    }
    ...
    private void getint(){
        ...
        section_heading.setText("Bathroom Cleaning Service");
    ...
    public void settingupTheRecyclerView(){
        ...
        data.add(new SectionViewAllServiceListModel("One Bathroom Cleaning","120","40","Bathroom Cleaning","60 min",0,0,R.drawable.bathroom));
        data.add(new SectionViewAllServiceListModel("Two Bathroom Cleaning","180","40","Bathroom Cleaning","60 min",0,0,R.drawable.bathroom));
        data.add(new SectionViewAllServiceListModel("Three Bathroom Cleaning","190","40","Bathroom Cleaning","60 min",0,0,R.drawable.bathroom));
        data.add(new SectionViewAllServiceListModel("Four Bathroom Cleaning","200","40","Bathroom Cleaning","60 min",0,0,R.drawable.bathroom));
        adapter = new SectionViewAllServiceListAdapter(this, data, new SectionViewAllServiceListAdapter.OnServiceItemClick() {
            ...
            public void onClick(String position, int pos, View view) {
                if (!position.equals("0")) {// !position.equals("0") is use to show or hide the visibility of bottom button
                    ...
                    Toast.makeText(ViewAllBathroomCleaningService.this,""+pos,Toast.LENGTH_SHORT).show();
                } else {
    ...
    public void onBackPressed() {
        startActivity(new Intent(ViewAllBathroomCleaningService.this,BathroomCleaning.class));
        finish();
    }
}
